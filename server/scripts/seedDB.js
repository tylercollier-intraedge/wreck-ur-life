...
const sampleEquipment = [
  {
    name: "Lawnmower",
    pictureURL: "http://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/John_Deere_lawn_mower.JPG/1280px-John_Deere_lawn_mower.JPG"
  },
...
const createRecords = async () => {
  ...
  const sampleRentals = [
    { user_id: userIds[0], user_fullname: "Jordan", equipment_id: equipIds[0], equipment_name: "Lawnmower", rental_date: tomorrow },
    { user_id: userIds[1], user_fullname: "John", equipment_id: equipIds[2], equipment_name: "Snow-Plow", rental_date: today },
